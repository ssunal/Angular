...
<div class="container">
	<div class="sixteen columns">
		...
		<nav id="navigation" class="menu">
			<ul id="responsive">
					<li><a href="#" id="current" >For Candidates</a>
						<ul>
								<?php  if($login=='1' && $typeOfUser=='Candidate')
								{
									echo'
							<li><a href="candidateProfile.php">Update my profile</a></li>';}
							 ?>
			...
			<li><a href="#">For Employers</a>
						<ul>
							<?php  if($typeOfUser=='Employer')
							{
								echo
								'
								<li><a href="employerProfile.php">Update my profile</a></li>
							<li><a href="create-company.php">Create your company</a></li>
							<li><a href="add-job.php">Add Job (job manager yetkisine bağlı)</a></li>
							<li><a href="manage-jobs.php">manage Jobs (job manager yetkiye bağlı / silme / düzeltme/ yürürlükten kaldır yeniden yürürlüğe al)</a></li>
							<li><a href="manage-applications.php">Manage Applications (yetkiye bağlı)</a></li>
							<li><a href="browse-resumes.php">Browse Resumes (yetkiye bağlı)</a></li>
					';	}else {
						echo	' <li><a href="AboutCompany.php">About</a></li>
					';
					}
									?>
						</ul>
				...
				<li><a href="#">For Universities</a>
									<ul>
										<?php  if($typeOfUser=='University')
										{
													echo	'							<li><a href="">(Buranın altını login olduktan sonra dolduralım. Contact olmayacak mı?)</a></li>
													';
												} else {
												echo	' <li><a href="AboutUniversity.php">About</a></li>
												';
												}
													 ?>
									</ul>
        ...
        <?php
				$x = '<li><a href="my-register.php"><i class="fa fa-user"></i> Sign Up</a></li> ';
				$y= '<li><a href="my-login.php#tab1"><i class="fa fa-lock"></i> Log In</a></li>';
        $z=	'<li><a href="logout.php"><i class="fa fa-unlock"></i> Log Out</a></li>';
           if($login=='1')
           {
              echo $z;
           } else {
	...
	<div class="container">
		...
		<div class="three columns">
			...
			<ul class="footer-links">
				...
				<li><a href="contactfirst.php">Contact Us</a></li>
